...
1- Total Seats
2- What are thr Total number of seats available for elction result
...
10- What is the total number of seats won by each party alliance (NDA, I.N.D.I.A, and OTHER) in each state for the India Elections 2024
11- Which candidate received the highest number of EVM votes in each constituency (Top 10)?
12- Which candidate won and which candidate was the runner-up in each constituency of State for the 2024 elections?
13- For the state of Uttar Pradesh, what are the total number of seats, total number of candidates,
...
------ If want Specific state and constituency  ----------------------------------------------------------------------------------
...
----- 9- Which parties won the most seats in s State, and how many seats did each party win? -----
